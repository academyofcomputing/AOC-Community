...
SCREEN_WIDTH = 600
SCREEN_HEIGHT = 600
SCREEN_TITLE = "Metero Shooter"
LEFT_LIMIT = -OFFSCREEN_SPACE
RIGHT_LIMIT = SCREEN_WIDTH + OFFSCREEN_SPACE
BOTTOM_LIMIT = -OFFSCREEN_SPACE
TOP_LIMIT = SCREEN_HEIGHT + OFFSCREEN_SPACE

# start_x, start_y is the bottom left corner of the word START displayed on screen
START_START_X = 250
START_START_Y = 280
# how to find the width and height for the word START?
START_WIDTH = 100
START_HEIGHT = 50

GAMEOVER_START_X = 180
GAMEOVER_START_Y = 280


# list down all images and sounds used in the game
BULLET_IMAGE = "images/laser.png"

METEOR_BIG_IMAGE_LIST = ["images/meteorGrey_big1.png",
              "images/meteorGrey_big2.png",
              "images/meteorGrey_big3.png",
              "images/meteorGrey_big4.png"]

METEOR_MED_IMAGE_LIST = ["images/meteorGrey_med1.png",
              "images/meteorGrey_med2.png"]

METEOR_SMALL_IMAGE_LIST = ["images/meteorGrey_small1.png",
              "images/meteorGrey_small2.png"]

METEOR_TINY_IMAGE_LIST = ["images/meteorGrey_tiny1.png",
              "images/meteorGrey_tiny2.png"]

SHIP_IMAGE = "images/spaceship.png"
SHIPLIFE_IMAGE = "images/spaceship_life.png"

LASER_SOUND = "sounds/hurt5.wav"
...
class ShipSprite(arcade.Sprite):
    ...
    def update(self):
        ...
        if self.respawning:
            ...
            # as alpha changes from 2, 3,...255, the spaceship changes from transparent, semi-transparent to opaque.
...
class ShooterGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        # use the next line of code to find the width and height of the word START?
        # print("clicked at ", x, y)
        if not self.game_start:
            if (button == arcade.MOUSE_BUTTON_LEFT):
                if (x > START_START_X and x < START_START_X+START_WIDTH):
                    if(y > START_START_Y and y < START_START_Y+START_HEIGHT):
        ...
        if self.game_start and not self.game_over:
            ...
            for bullet in self.bullet_list:
                ...
                for meteor in meteors:
                    self.split_meteor(cast(MeteorSprite, meteor))  # expected MeteorSprite, got Sprite instead
    ...
    def on_draw(self):
        ...
        if not self.game_start:
            start = f"Start"
            arcade.draw_text(start, START_START_X, START_START_Y, arcade.color.WHITE, 35)
            ...
            over = f"Game Over"
            arcade.draw_text(over, GAMEOVER_START_X, GAMEOVER_START_Y, arcade.color.WHITE, 35)
